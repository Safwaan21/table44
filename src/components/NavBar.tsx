...
export default function NavBar() {
    ...
    >
        ...
        <img src="/logo.png" alt="Logo" className="max-w-[52px] max-h-[52px]"/>
        </a>
        ...
        <div className="flex items-center gap-4">
            ...
            <a
                className="block rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700 dark:hover:bg-teal-500"
                href="/login"
            >
                Login
            </a>
